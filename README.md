...
工程不依赖第三方NuGet包。33项自动化测试覆盖定位、任务栏间距、悬停倍率、极端缩放光晕边界、动态图标发光、主题选项、全部设置边界、配置迁移、异步命令、防抖与并发保存、保存失败、配置恢复只读保护、版本门禁、导入事务、订阅者隔离、资源一致性、托盘状态和关键XAML交互约束。手工验收项见`docs/TESTING.md`。
