...
public sealed class AppSettings : ObservableObject
{
    ...
    public double BackgroundOpacity { get => _backgroundOpacity; set => SetProperty(ref _backgroundOpacity, Math.Clamp(double.IsNaN(value) ? 0 : value, 0, 1)); }
    public double IconSize { get => _iconSize; set => SetProperty(ref _iconSize, Math.Clamp(double.IsNaN(value) ? 0 : value, 28, 112)); }
    public double IconSpacing { get => _iconSpacing; set => SetProperty(ref _iconSpacing, Math.Clamp(double.IsNaN(value) ? 0 : value, 0, 48)); }
    public double DockScale { get => _dockScale; set => SetProperty(ref _dockScale, Math.Clamp(double.IsNaN(value) ? 0 : value, 0.65, 1.8)); }
    public double PanelPadding { get => _panelPadding; set => SetProperty(ref _panelPadding, Math.Clamp(double.IsNaN(value) ? 0 : value, 4, 36)); }
    public double CornerRadius { get => _cornerRadius; set => SetProperty(ref _cornerRadius, Math.Clamp(double.IsNaN(value) ? 0 : value, 0, 36)); }
    public double ReflectionOpacity { get => _reflectionOpacity; set => SetProperty(ref _reflectionOpacity, Math.Clamp(double.IsNaN(value) ? 0 : value, 0, 0.7)); }
    public double GlowIntensity { get => _glowIntensity; set => SetProperty(ref _glowIntensity, Math.Clamp(double.IsNaN(value) ? 0 : value, 0, 1)); }
    public double HoverScale { get => _hoverScale; set => SetProperty(ref _hoverScale, Math.Clamp(double.IsNaN(value) ? 0 : value, 1, 1.65)); }
    public double AdjacentHoverScale { get => _adjacentHoverScale; set => SetProperty(ref _adjacentHoverScale, Math.Clamp(double.IsNaN(value) ? 0 : value, 1, 1.3)); }
    ...
    public string? MonitorId { get => _monitorId; set => SetProperty(ref _monitorId, value); }
    public double? RelativeX { get => _relativeX; set => SetProperty(ref _relativeX, value); }
    public double? RelativeY { get => _relativeY; set => SetProperty(ref _relativeY, value); }
